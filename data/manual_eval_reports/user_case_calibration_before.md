...
- romance_tension_reason: 男女主虽未直接同场，但形成了“明面绝情抛弃+暗地隐秘在意”的强拉扯感，潜台词清晰：男主的追问藏着不安，女主的狠话藏着未熄的恨意，身份落差进一步放大了张力。
- relationship_progression_reason: 本章完成了关系的明确质变：从“失散六年、仍抱有等待希望的夫妻”，转变为“被高位者冷酷抛弃、关系明面断裂但暗线未断”的状态，变化清晰且有层次。
- redundancy_reason: 存在少量重复的情绪表达，主要集中在女主对“六年白费”的抱怨上，部分直白叙述略显冗余，但整体不影响情节推进。

## weak_reject_mother_son_pressure

- title: 归宗礼上的旧案威压
- expected_verdict: `needs_work`
...
- top_targets: prompts/writer/step_8_chapter_briefs.txt, prompts/writer/write_chapter_full.txt, prompts/writer/plan_content_blocks.txt, prompts/writer/step_8_chapter_briefs.txt, prompts/writer/plan_content_blocks.txt
...
| character_attraction_score | 1.20 |
| hook_score | 1.50 |
| continuity_score | 8.00 |
| redundancy_score | 4.00 |
| mind_state_consistency_score | 9.00 |

- romance_tension_reason: 男女主之间仅存在旧案权力对峙的压迫感，无任何言情层面的拉扯、试探、情感回避或暧昧靠近，所有互动均围绕权力报复展开，完全不具备言情张力。
- relationship_progression_reason: 本章内男女主关系未发生任何有效变化，始终维持旧案对立的权力状态，无情感层面的升温、误会加深或情绪松动。
- redundancy_reason: 结尾重复了相同的权力威胁话语，属于无效重复铺陈，未带来新信息或情绪递进，反而削弱了结尾的冲击力。
...
- actual_verdict: `blocked`
- matched_expectation: `true`
- hard_fail_flags: continuity_break, relationship_progression_break, hook_underpowered, mind_state_break, redundancy_drag, romance_pull_weak
...
| hook_score | 0.50 |
| continuity_score | 2.00 |
| redundancy_score | 0.00 |
| mind_state_consistency_score | 5.00 |

- romance_tension_reason: 男女主之间没有任何实质性的拉扯、试探、回避或压迫互动，仅靠反复重复“很冷”的空洞标签堆砌，完全缺失言情核心的张力与潜台词。
- relationship_progression_reason: 本章关系全程原地踏步，从开头到结尾始终停留在“互相冷漠”的初始状态，没有任何情绪松动、误会加深或试探升级的有效变化。
- redundancy_reason: 大量重复“她很冷，他也很冷”的情绪标签，至少重复五次，无任何新信息补充，冗余严重，浪费篇幅。
