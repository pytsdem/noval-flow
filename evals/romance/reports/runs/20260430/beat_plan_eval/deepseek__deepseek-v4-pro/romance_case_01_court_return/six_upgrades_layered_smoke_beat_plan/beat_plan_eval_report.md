# Beat Plan Eval: six_upgrades_layered_smoke_beat_plan

- provider: `deepseek`
- model: `deepseek-v4-pro`
- generated_at: `2026-04-30T05:25:10.895318+00:00`
- cases: `1`
- average_score: `9.14`
...
| metric | score |
| --- | ---: |
| adjacent_separation_score | 9.30 |
| beat_count_fit | 9.20 |
| beat_uniqueness_score | 9.40 |
| contract_coverage_score | 10.00 |
| dramatic_pressure_flow_score | 10.00 |
| must_not_repeat_quality | 8.90 |
| progression_clarity_score | 7.20 |
