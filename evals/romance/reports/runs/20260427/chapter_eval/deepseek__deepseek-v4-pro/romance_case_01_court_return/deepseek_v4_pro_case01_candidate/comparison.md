# Comparison Report: deepseek_v4_pro_case01_candidate vs candidate_beat_card_case01_clean
...
- guard_metric_delta: `-0.50`
- blocked_case_delta: `+0`
- pairwise_preferred_side: `baseline`
- pairwise_weighted_margin: `-16.00`
...
| emotional_resonance_score | -1.20 |
| character_attraction_score | -0.75 |
| hook_score | +0.50 |
| continuity_score | -0.80 |
| redundancy_score | -1.01 |
...
- tied_case_count: `0`
- weighted_margin: `-16.00`
- delta_threshold: `0.20`

| case_id | preferred | margin | candidate wins | baseline wins | guard failures | cost flags |
| --- | --- | ---: | --- | --- | --- | --- |
| romance_case_01_court_return | baseline | -16.00 | hook_score, mind_state_consistency_score | romance_tension_score, relationship_progression_score, emotional_resonance_score, character_attraction_score, continuity_score, redundancy_score | continuity_score, redundancy_score | duration_seconds>+20 |
